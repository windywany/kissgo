...
class ThumbPreferenceForm extends BootstrapForm {
    ...
    var $enable_watermark = array (FWT_LABEL => '启用水印', FWT_WIDGET => 'scheckbox', FWT_TIP => '启用水印后，每个上传的图片都将添加水印图片.' );
    var $watermark_pic = array (FWT_LABEL => '水印图片', FWT_WIDGET => 'file', FWT_TIP => '水印图片.', 'pcls' => 'pull-left', 'ecls' => 'span4', FWT_VALIDATOR => array ('regexp(/.+\.(jpg|jpeg|png|bmp)$/i)' => '你只能上传jpg,png,bmp类型的图片,大小不超过10KB.' ) );
