...
<div class="tabbable ui-tabwrap">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                ...
                <table id="group-list" class="table table-striped table-bordered table-condensed ui-table">
				<thead>
					<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{$_CUR_URL}/edit?rid={$item.rid}">{$item.label}</a></td>
						<td><a href="{$_CUR_URL}/edit?rid={$item.rid}">{$item.name}</a></td>						
			...
			<div class="form-horizontal">
			    <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">{'get_user_bench_options'|fire}</ul>
                </div>
