	...
	(function($) {
		...
		$.fn.blockit = function() {
			...
			if (!id) {
				...
				var block = $('<div id="'+id+'-overlay"></div>').css({cursor:'wait',position:'absolute',width:w,height:h,'z-index':29999,background:'#FFF',display:'none',top:0,left:0}).appendTo($this);
